...
cd /home/ubuntu/
TOKEN=$(aws --region=us-east-1 ssm get-parameter --name /oduor/capstone/token --with-decryption --query 'Parameter.Value' --output text)
git clone https://$TOKEN@github.com/aredo01/aws-capstone.git
